...
<div class="breadcrumbs"> 
    ...
    <a href="{{ route('admin-snippets') }}">Snippet Managment</a>
...
<div class="inner-content">
        ...
        <div class="content-box">
            ...
            <form class="add" method="post" action="{{ route('admin-edit-snippet-post', $snippet_data->slug) }}" role="form">
