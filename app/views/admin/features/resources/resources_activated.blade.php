...
{{-- Page title --}}
@section('title', 'Activated Resources')
...
<div class="page-header">
	...
	<div class="large-6 columns">
        <div class="title">
            <h4><i class="fa fa-rocket"></i><a class="dash-title" href="{{ route('admin-resources') }}"> @yield('title') </a></h4>
        </div>
    </div>
...
<div class="breadcrumbs"> 
    ...
    <a href="{{ route('admin-resources') }}">Resource Management</a>
    <a class="unavailable">Activated Resources</a>
</div>
	    ...
	    <tbody>
		    @foreach ($all_resources as $resource)
		        ...
		        <tr>
		    	    ...
		    	    <td>
		    	        <a href="{{ route('admin-deactivate-resource', $resource->id) }}" class="is-feed-delete" title="Deactivate Resource"><i class="fa fa-times"></i></a>
